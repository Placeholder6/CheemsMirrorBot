...
cancel_mirror_handler = CommandHandler(BotCommands.CancelMirror, cancel_mirror,
                                       filters=(CustomFilters.authorized_chat | CustomFilters.authorized_user | CustomFilters.admins | CustomFilters.owners) & CustomFilters.mirror_owner_filter, run_async=True)
